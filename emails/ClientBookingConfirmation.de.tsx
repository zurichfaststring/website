...
export const ClientBookingConfirmationDE = (props: Props) => (
  <Html>
    <Head />
    <Body style={{fontFamily:'Arial,sans-serif',backgroundColor:'#f5f5f5',margin:0,padding:'20px 0'}}>
      ...
      <Container style={{maxWidth:'500px',margin:'0 auto',backgroundColor:'#fff',borderRadius:'8px'}}>
        ...
        <Section style={{padding:'20px'}}>
          ...
          <Text style={{fontSize:'14px',margin:'0 0 10px'}}>Hallo {props.clientName},</Text>
          <Text style={{fontSize:'13px',color:'#333',margin:'0 0 20px'}}>
            Ihre Besaitungsbuchung wurde bestätigt.
          </Text>
          
          <table style={{width:'100%',margin:'20px 0',borderTop:'1px solid #ddd',borderBottom:'1px solid #ddd'}}>
            <tr><td style={{padding:'8px 0',fontSize:'12px',color:'#666',width:'35%'}}>Datum:</td><td style={{padding:'8px 0',fontSize:'12px',fontWeight:'500'}}>{props.bookingDate}</td></tr>
            <tr><td style={{padding:'8px 0',fontSize:'12px',color:'#666'}}>Zeitfenster:</td><td style={{padding:'8px 0',fontSize:'12px',fontWeight:'500'}}>{props.timeSlot}</td></tr>
            <tr><td style={{padding:'8px 0',fontSize:'12px',color:'#666'}}>Schläger:</td><td style={{padding:'8px 0',fontSize:'12px',fontWeight:'500'}}>{props.racketBrand} {props.racketModel}</td></tr>
            <tr><td style={{padding:'8px 0',fontSize:'12px',color:'#666'}}>Muster:</td><td style={{padding:'8px 0',fontSize:'12px',fontWeight:'500'}}>{props.stringPattern}</td></tr>
            <tr><td style={{padding:'8px 0',fontSize:'12px',color:'#666'}}>Spannung:</td><td style={{padding:'8px 0',fontSize:'12px',fontWeight:'500'}}>{props.tension}</td></tr>
            <tr><td style={{padding:'8px 0',fontSize:'12px',color:'#666'}}>Saite:</td><td style={{padding:'8px 0',fontSize:'12px',fontWeight:'500'}}>{props.stringType}</td></tr>
          </table>
          
          <Text style={{fontSize:'18px',fontWeight:'bold',color:'#b1cb29',textAlign:'center',margin:'20px 0 10px'}}>
            Gesamtpreis: {props.totalPrice} CHF
          </Text>
          <Text style={{fontSize:'12px',color:'#666',textAlign:'center',margin:'0 0 20px'}}>
            Zahlung: TWINT oder Bar vor Ort
          </Text>
          ...
          <Section style={{backgroundColor:'#25D366',border:'3px solid #1DA851',borderRadius:'8px',padding:'20px',margin:'25px 0',textAlign:'center'}}>
            ...
            <Text style={{fontSize:'14px',color:'#fff',margin:'0 0 15px',lineHeight:'1.5'}}>
              Senden Sie eine WhatsApp-Nachricht zur Bestätigung der genauen Abgabezeit
            </Text>
          ...
          <Section style={{backgroundColor:'#f2f7e6',border:'2px solid #b1cb29',borderRadius:'6px',padding:'15px',margin:'20px 0',textAlign:'center'}}>
            <Text style={{fontSize:'13px',fontWeight:'bold',margin:'0 0 5px'}}>Abgabeadresse</Text>
          ...
          <Text style={{fontSize:'11px',color:'#999',textAlign:'center',margin:'20px 0 0',borderTop:'1px solid #ddd',paddingTop:'15px'}}>
            E-Mail: <Link href="mailto:info@zurichfaststring.ch" style={{color:'#b1cb29',textDecoration:'underline'}}>info@zurichfaststring.ch</Link>
          </Text>
        </Section>
      </Container>
    </Body>
...
export default ClientBookingConfirmationDE;
