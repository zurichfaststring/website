...
export const ClientBookingConfirmationEN = (props: Props) => (
  <Html>
    <Head />
    <Body style={{fontFamily:'Arial,sans-serif',backgroundColor:'#f5f5f5',margin:0,padding:'20px 0'}}>
      ...
      <Container style={{maxWidth:'500px',margin:'0 auto',backgroundColor:'#fff',borderRadius:'8px'}}>
        ...
        <Section style={{padding:'20px'}}>
          ...
          <Text style={{fontSize:'14px',margin:'0 0 10px'}}>Hello {props.clientName},</Text>
          <Text style={{fontSize:'13px',color:'#333',margin:'0 0 20px'}}>
            Your stringing booking has been confirmed.
          </Text>
          ...
          <table style={{width:'100%',margin:'20px 0',borderTop:'1px solid #ddd',borderBottom:'1px solid #ddd'}}>
            ...
            <tr><td style={{padding:'8px 0',fontSize:'12px',color:'#666'}}>Time slot:</td><td style={{padding:'8px 0',fontSize:'12px',fontWeight:'500'}}>{props.timeSlot}</td></tr>
            <tr><td style={{padding:'8px 0',fontSize:'12px',color:'#666'}}>Racket:</td><td style={{padding:'8px 0',fontSize:'12px',fontWeight:'500'}}>{props.racketBrand} {props.racketModel}</td></tr>
            <tr><td style={{padding:'8px 0',fontSize:'12px',color:'#666'}}>Pattern:</td><td style={{padding:'8px 0',fontSize:'12px',fontWeight:'500'}}>{props.stringPattern}</td></tr>
            ...
            <tr><td style={{padding:'8px 0',fontSize:'12px',color:'#666'}}>String:</td><td style={{padding:'8px 0',fontSize:'12px',fontWeight:'500'}}>{props.stringType}</td></tr>
          </table>
          
          <Text style={{fontSize:'18px',fontWeight:'bold',color:'#b1cb29',textAlign:'center',margin:'20px 0 10px'}}>
            Total price: {props.totalPrice} CHF
          </Text>
          <Text style={{fontSize:'12px',color:'#666',textAlign:'center',margin:'0 0 20px'}}>
            Payment: TWINT or Cash on-site
          </Text>
          ...
          <Section style={{backgroundColor:'#25D366',border:'3px solid #1DA851',borderRadius:'8px',padding:'20px',margin:'25px 0',textAlign:'center'}}>
            ...
            <Text style={{fontSize:'14px',color:'#fff',margin:'0 0 15px',lineHeight:'1.5'}}>
              Send a WhatsApp message to confirm the exact drop-off time
            </Text>
          ...
          <Section style={{backgroundColor:'#f2f7e6',border:'2px solid #b1cb29',borderRadius:'6px',padding:'15px',margin:'20px 0',textAlign:'center'}}>
            <Text style={{fontSize:'13px',fontWeight:'bold',margin:'0 0 5px'}}>Drop-off address</Text>
...
export default ClientBookingConfirmationEN;
